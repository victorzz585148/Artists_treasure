...
--
-- Table structure for table `oen_sequence`
--

DROP TABLE IF EXISTS `oen_sequence`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `oen_sequence`
--

/*!40000 ALTER TABLE `oen_sequence` DISABLE KEYS */;
INSERT INTO `oen_sequence` VALUES (2),(3),(4);
/*!40000 ALTER TABLE `oen_sequence` ENABLE KEYS */;

--
-- Table structure for table `oend_sequence`
--

DROP TABLE IF EXISTS `oend_sequence`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `oend_sequence`
--

/*!40000 ALTER TABLE `oend_sequence` DISABLE KEYS */;
INSERT INTO `oend_sequence` VALUES (2),(3),(4);
/*!40000 ALTER TABLE `oend_sequence` ENABLE KEYS */;

--
-- Table structure for table `onlineexhibition`
--

DROP TABLE IF EXISTS `onlineexhibition`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `onlineexhibition`
--

/*!40000 ALTER TABLE `onlineexhibition` DISABLE KEYS */;
INSERT INTO `onlineexhibition` VALUES ('OEN00002','梵谷藝術之旅','2024-08-22','2024-10-02',1,'VAN GOGH',NULL),('OEN00003','梵谷藝術之旅','2024-08-22','2024-10-02',1,'VAN GOGH',NULL),('OEN00004','梵谷藝術之旅','2024-08-22','2024-10-02',1,'VAN GOGH',NULL);
/*!40000 ALTER TABLE `onlineexhibition` ENABLE KEYS */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `before_insert_onlineexhibition` BEFORE INSERT ON `onlineexhibition` FOR EACH ROW BEGIN
    DECLARE new_seq INT;
    DECLARE new_id VARCHAR(8);
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `before_delete_onlineexhibition` BEFORE DELETE ON `onlineexhibition` FOR EACH ROW BEGIN
    -- 刪除 sequence 表中的對應序號
...
--
-- Table structure for table `onlineexhibitiondetail`
--

DROP TABLE IF EXISTS `onlineexhibitiondetail`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `onlineexhibitiondetail` (
  ...
  KEY `OEN_ID` (`OEN_ID`),
  KEY `COL_ID` (`COL_ID`),
  CONSTRAINT `onlineexhibitiondetail_ibfk_1` FOREIGN KEY (`AK_ID`) REFERENCES `artwork` (`AK_ID`),
  CONSTRAINT `onlineexhibitiondetail_ibfk_2` FOREIGN KEY (`OEN_ID`) REFERENCES `onlineexhibition` (`OEN_ID`),
  CONSTRAINT `onlineexhibitiondetail_ibfk_3` FOREIGN KEY (`COL_ID`) REFERENCES `collection` (`COL_ID`),
  CONSTRAINT `onlineexhibitiondetail_chk_1` CHECK ((((`AK_ID` is not null) and (`COL_ID` is null)) or ((`AK_ID` is null) and (`COL_ID` is not null))))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `onlineexhibitiondetail`
--

/*!40000 ALTER TABLE `onlineexhibitiondetail` DISABLE KEYS */;
INSERT INTO `onlineexhibitiondetail` VALUES ('OEND00002','OEN00002','AK00001',NULL,NULL),('OEND00003','OEN00002','AK00001',NULL,NULL),('OEND00004','OEN00002','AK00001',NULL,NULL);
/*!40000 ALTER TABLE `onlineexhibitiondetail` ENABLE KEYS */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `before_insert_onlineexhibitiondetail` BEFORE INSERT ON `onlineexhibitiondetail` FOR EACH ROW BEGIN
    DECLARE new_seq INT;
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `before_delete_onlineexhibitiondetail` BEFORE DELETE ON `onlineexhibitiondetail` FOR EACH ROW BEGIN
    -- 刪除 sequence 表中的對應序號
...
-- Dump completed on 2024-10-02 21:25:13
