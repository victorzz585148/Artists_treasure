...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `AK_THEME_CATCH` BEFORE INSERT ON `artwork` FOR EACH ROW BEGIN
...
INSERT INTO `col_sequence` VALUES (1),(2);
...
INSERT INTO `collection` VALUES ('COL00001','2024-09-27','VAN GOGH','Self portrait as a painter','Oil Painting','65.1,50',1888,NULL,'self-portrait','2024-09-22',98800000,'Van Gogh presented himself in this self-portrait as a painter, holding a palette and paintbrushes behind his easel. He showed that he was a modern artist by using a new painting style, with bright, almost unblended colours. The palette contains the complementary colour pairs red/green, yellow/purple and blue/orange – precisely the colours Van Gogh used for this painting. He laid these pairs down side by side to intensify one another: the blue of his smock, for instance, and the orange-red of his beard.',4,'臥室','C:\\Users\\LTU\\Desktop\\Media\\Self portrait as a painter.jpg',0,'sothebys'),('COL00002','2024-09-25','VAN GOGH','Café Terrace at Night','Oil Painting','80.7,65.3',1888,9,'landscape painting','2024-07-28',745220000,'Café Terrace at Night is an 1888 oil painting by the Dutch artist Vincent van Gogh. It is also known as The Cafe Terrace on the Place du Forum, and, when first exhibited in 1891, was entitled Coffeehouse, in the evening (Café, le soir).',3,'庫勒穆勒博物館','C:\\Users\\LTU\\Desktop\\Media\\Café Terrace at Night.jpg',1,'sothebys');
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `COL_THEME_CATCH` BEFORE INSERT ON `collection` FOR EACH ROW BEGIN
    DECLARE theme_name VARCHAR(30);
...
INSERT INTO `te_sequence` VALUES (1);
...
CREATE TABLE `theme` (
  ...
  CONSTRAINT `theme_ibfk_1` FOREIGN KEY (`TE_NAME`) REFERENCES `artwork` (`AK_THEME`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-09-27 15:54:09
